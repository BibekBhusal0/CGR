...
export function ColorPicker() {
  ...
  return (
    <div className="flex flex-col justify-center gap-5">
      <div style={customStyle} className="rounded-md p-2 text-center text-2xl font-bold">
        TEST
      </div>
...
export function ColorReducer(state: ColorStateType, action: ColorAction): ColorStateType {
  switch (action.type) {
    default:
      return state;
    case "SetColor":
