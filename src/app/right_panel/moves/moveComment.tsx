...
export const MoveComment: FC = () => {
  ...
  return (
    <div className="bg-accent-soft flex flex-col gap-2 rounded-md px-4 py-3 sm:px-8">
      {moveIndex === -1 ? (
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              {!bestMove && (
                <Button
                  variant="danger"
                  onPress={() =>
                    toast.info("Retry is not available yet", {
                      description: "Retry functionality is coming soon.",
                    })
                  }>
